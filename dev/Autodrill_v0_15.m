...
classdef Autodrill_v0_15 < handle
    ...
    methods
        function obj = set.DATA_AVAILABLE(obj,value)
        end
    end
    methods (Access = public)
        %%Constructor...
        function obj = Autodrill_v0_15(NiDAQ_board,remote)
...
%                 end
        ...
        function [job,task]=sendDaqOnParallel(obj)
             ...
             task = createTask(job,@eval,0, {'auto=Autodrill_v0_15(''shitty'',0);auto.sendDaqProbePulse(100,1000)'});
...
%                    drawnow;
        ...
        %daq is 48000 (48Khz)
         function [data,time]=acquireDAQProbePulse(obj,acquisition_type, rate,duration, data_update_size,time_to_sample)
                obj.in_s.Rate = rate;
                obj.in_s.DurationInSeconds = duration;
...
%              obj.Autodrill(obj,cond);
    ...
    methods (Access = private)
        ...
        function analyzeTrigger(obj,event,sampling_rate,start_time_obj, start_time_seconds,time_to_sample)
%           time = event.TimeStamps;
            ...
            if curTime < (start_time_seconds+time_to_sample)
%                 obj.analyzeCurrentSignal(data,sampling_rate);
            else
                %Get rid of event listener
                    %event -- access to nidaq
                    obj
%                 event.listener.Enabled = false;
            end
        end
